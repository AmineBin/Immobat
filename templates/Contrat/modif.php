...
<div class="row mb-3">
        ...
        <div class="col-sm-12">
            ...
            <select class="form-select form-select-md" name="lstAppart">
                <?php foreach ($lesApparts as $unAppart) {
                    ...
                    if (isset($lContrat) && $lContrat->GetAppartement()->GetId() == $id)
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-12">
            <input type="date" class="form-control" name="debut" value="<?php if (isset($lContrat))  echo $lContrat->GetDebut()->format("Y-m-d");  ?>" id="debut">
        </div>
    </div>
    <div class="row mb-3">
        <label for="fin" class="col-lg-4 col-form-label">Fin</label>
        <div class="col-sm-12">
            <input type="date" class="form-control" name="fin" value="<?php if (isset($lContrat) && $lContrat->GetFin() != null)  echo $lContrat->GetFin()->format("Y-m-d");  ?>" id="fin">
        </div>
    </div>
    <div class="row mb-3">
    ...
    <input type="hidden" name="idContrat" value="<?php if ($lContrat != null) echo $lContrat->getId(); ?>" <div class="row mb-3">

...
abstract class Repository
{
	...
	public function dbConnect()
	{
		...
		// le fichier de configuration pour les accès à la bdd doit être inclus dans la méthode 
		// sans quoi la variable $configDatabaseDev ne sera pas accessible dans cette dernière 
